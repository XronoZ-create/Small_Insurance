...
class GetModificationJson:
    def __init__(self, mark, model, modification, proxies=None):
        ...
        self.headers = {
            'Host': 'e-osago.ugsk.ru', 'Connection': 'keep-alive', 'Content-Length': '974',
            'sec-ch-ua': '"Chromium";v="94", "Google Chrome";v="94", ";Not A Brand";v="99"',
            'Accept': 'application/json, text/plain, */*', 'Content-Type': 'application/json',
            'sec-ch-ua-mobile': '?0',
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.61 Safari/537.36',
            'sec-ch-ua-platform': '"Windows"', 'Origin': 'https://e-osago.ugsk.ru',
            'Sec-Fetch-Site': 'same-origin', 'Sec-Fetch-Mode': 'cors', 'Sec-Fetch-Dest': 'empty'
        }
        if proxies != None:
            self.r = requests.post(
                "https://e-osago.ugsk.ru/local/tools/webslon/elpolis.api/",
