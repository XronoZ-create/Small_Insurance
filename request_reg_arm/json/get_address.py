...
class GetAddressJson:
    ...
    def __call__(self, *args, **kwargs):
        ...
        self.r = requests.get("https://dadata.ru/api/v2/suggest/address/", params=self.params, headers=self.headers)
        self.r_json = self.r.json()
        print(self.r_json)
        self.json = \
            {
                "buildingId": self.r_json["suggestions"][0]["data"]["street_kladr_id"],
                ...
                "fias_id": self.r_json["suggestions"][0]["data"]["house_fias_id"],
