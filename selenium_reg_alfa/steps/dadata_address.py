...
class GetAddressJson:
    ...
    def __call__(self, *args, **kwargs):
        ...
        self.json = {
            ...
            "Apartment": self.r_json["suggestions"][0]["data"]["house"],
            "Building": self.r_json["suggestions"][0]["data"]["block"],
            "Zip": self.r_json["suggestions"][0]["data"]["postal_code"],
            ...
            "CountryCode": "",
            "Address": self.r_json["suggestions"][0]["value"],
            "Separated": "0",
        }
        return self.json