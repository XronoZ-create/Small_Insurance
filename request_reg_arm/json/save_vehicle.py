import json
from request_reg_arm.json.get_modification import GetModificationJson
...
class SaveVehicleJson:
    ...
    """
    def __init__(self, proxies, target, document_type, reg_number,
                 year, mark, model, category, ptc_ctc_series=None, ptc_ctc_number=None, ptc_ctc_date=None, eptc_number=None, eptc_date=None,
